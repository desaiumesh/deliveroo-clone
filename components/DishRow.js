...
const DishRow = ({ id, name, description, price, image }) => {
    ...
    //Dispatch or push items to basket
    ...
    //use selector to access the basket with id of dish
                ...
                <View className="flex-row">
                    ...
                    <View>
                        <Image
                            ...
                            className="h-20 w-20 pd-4 bg-gray-300" />
                    </View>
                </View>
            </TouchableOpacity>
            {
                    ...
                    <View className="bg-white px-4">
                        <View className="flex-row items-center space-x-2 pb-3">
                            <TouchableOpacity onPress={removeItemFromBasket}>
                                <MinusCircleIcon color="#00CCBB" size={40}></MinusCircleIcon>
                            </TouchableOpacity>
